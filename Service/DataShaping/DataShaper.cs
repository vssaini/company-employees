...
namespace Service.DataShaping
{
    public class DataShaper<T> : IDataShaper<T> where T : class
    {
        ...
        private static IEnumerable<ShapedEntity> FetchData(IEnumerable<T> entities, IEnumerable<PropertyInfo> requiredProperties)
        {
        ...
        private static ShapedEntity FetchDataForEntity(T entity, IEnumerable<PropertyInfo> requiredProperties)
        {
            ...
            var propValue = objectProperty.GetValue(entity);
            shapedEntity.Id = propValue != null ? (Guid)propValue : Guid.Empty;
